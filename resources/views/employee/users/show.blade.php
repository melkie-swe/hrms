                ...
                <div  class="tab-content mar-top" id="clothing-nav-content">
                                        ...
                                        <div class="col-md-8">
                                                <div class="table-responsive-lg table-responsive-sm table-responsive-md table-responsive">
                                                    <table class="table table-bordered table-striped" id="users">
                                                        ...
                                                        <tr>
                                                            <td>@lang('users/title.id')</td>
                                                            <td>
                                                                <p class="user_name_max">{{ $user->rperson->id_number ?? null }}</p>
                                                            </td>

                                                        </tr>
                                                        {{-- enter from department table --}}
                                                        {{-- <tr>
                                                            <td>@lang('users/title.department')</td>
                                                            <td>
                                                                <p class="user_name_max">{{$department}}</p>
                                                            </td>

                                                        </tr> --}}
                                                        <tr>
                                                            <td>@lang('users/title.mobile')</td>
                                                            <td>
                                                                {{ $user->rperson->mobile ?? null }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                    ...
                    <div id="tab3" class="tab-pane fade">
                        <div class="row">
                            <div class="col-md-12 pd-top ml-auto">
                                 <!--main content-->
                                {!! Form::model($user, ['url' => URL::to('employee/my_account/filereset'), 'method' => 'post', 'class'
