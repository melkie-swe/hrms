...
{{-- 
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-12">
                <div>
                    <a href="{{ route('welcome') }}"> <img src="{{ asset('frontend/img/logo2.png') }}"
                            style="height: 60px; width: 140px" alt="logo" class="my-2 mx-2 text-center">
                    </a>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark sticky-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <a href="{{ route('welcome') }}"> <img src="{{ asset('frontend/img/logo2.png') }}"
                        style="height: 40px; width: 100px" alt="logo" class="my-2 mx-2 text-center">
                </a>
                {{-- <strong class="name">House Rental</strong> --}}
                {{-- <div class="mb-3" style="margin-left: 12px;" id="time"></div> --}}
