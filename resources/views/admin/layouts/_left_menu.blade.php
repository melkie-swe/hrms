<ul id="menu" class="page-sidebar-menu">
    ...
    {{-- user information --}}
    <li {!! (Request::is('admin/users') || Request::is('admin/bulk_import_users') || Request::is('admin/users/create') || Request::is('admin/user_profile')|| Request::is('admin/deleted_users') ? 'class="active"' : '' ) !!}>
        <a href="#">
