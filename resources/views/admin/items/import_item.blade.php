...
@section('content')
      <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">Import New Item</li>
        </ol>
    </section>
        <!-- Main content -->
                ...
                <div class="col-md-5">
                    <div class="card">
                        <div class="card-header bg-primary">
                            <h3 class="card-title float-left my-2">Import New Item</h3>
                             <a href="{{ URL::to('admin/download_users/xlsx') }}"><button class="btn btn-success float-right">Download</button></a>
                        </div>


                        <div class="card-body">
                            <form method="POST" action="{{ URL('admin/bulk_import_item') }}"  files="true" enctype="multipart/form-data">
                                {{ csrf_field() }}
