            ...
            <div class="portlet light bordered">
                <div class="portlet-body form">
                        ...
                        <div class="table-toolbar margin-top-15">
                            <div class="row">
                                <div class="col-md-4">
                                    {!! Form::open(['route'=>["admin.admin.attendances.create"], 'method' => 'GET', 'class' => "form-inline", 'id' => "new_date"]) !!}
                                    <div class="btn-group">
                                ...
                                <div class="col-md-4 text-center">
                                    @if(!$date->isToday())
                                        <a href="javascript:;"
                                           onclick="loadView('{{ route('admin.admin.attendances.create') }}');"
                        ...
                        @else
                            {!! Form::open(['route' => ["admin.admin.attendances.update", $date->format("Y-m-d")], 'class'=>'form-horizontal ajax_form', 'method'=>'PATCH']) !!}
...
@section('footer_scripts')
    ...
    <script src="{{ asset('assets/global/plugins/datatables/plugins/responsive/dataTables.responsive.min.js') }}"></script>
    <script src="{{ asset('assets/admin/pages/scripts/components-pickers.js') }}"></script>
    <script src="{{ asset('assets/js/ajaxform/jquery.form.min.js') }}"></script>
    <script src="{{ asset('assets/js/commonjs.js') }}"></script>
    <script src="{{ asset('assets/global/plugins/bootstrap-form-editable/bootstrap3-editable/js/bootstrap-editable.min.js') }}"></script>
...
//			 $('#halfDayLabel').show(100);
        ...
        $('#date_change').datepicker({
            ...
            var url = "{{ route("admin.admin.attendances.edit", "#id") }}";
        ...
        function ajaxUpdateAttendance() {
            ...
            var url = "{{ route("admin.admin.attendances.update", "#id") }}";
            url = url.replace("#id", date);
            ...
            $.ajax({
                ...
                success: function (response) {
                    ...
                    var route = "{{ route("admin.admin.attendances.edit", "#id") }}";
